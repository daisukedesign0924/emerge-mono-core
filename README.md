...
- 新しい文字ロゴと編集画面の余白調整を、GitHub自動更新経路で正式配布

## 1.28.10

- タイトル、URLスラッグ、編集可能フィールドへ一貫した左右余白を追加

## 1.28.9

- Codex接続承認画面へ新しいEmerge Mono文字ロゴを反映

## 1.28.8

- Core管理画面の左上ブランド表示を新しいEmerge Mono文字ロゴへ更新
